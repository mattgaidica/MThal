function extractSpikes_parfor( hsdFile, varargin )
%
...
% 11/2012 adjusted by RS using parfor loop (might be useful if you need to extract a single session)
