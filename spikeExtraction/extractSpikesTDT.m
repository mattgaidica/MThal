...
cd('C:\Box Sync\Box Sync\Leventhal Lab\Leventhal lab software\m-files\sqlDB functions');    % TAKE THIS LINE OUT ONCE I FIGURE OUT WHY MATLAB CAN'T FIND THIS FUNCTION ON THE SEARCH PATH
...
%                                         'dbname', dbName);
    ...
    extract_PLXtimestamps_sincInterp_TDT_20141208(sessionTDTpath, tetrodeList{iTet}, chMap.chMap(iTet, 2:end), tet_thresholds(iTet, :), validMask, ...
