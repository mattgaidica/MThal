/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// plxVTdecoderDlg.cpp : implementation file that contains functionality for 
// reading and displaying a PLX file.
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////

#include "stdafx.h"
#include "plxVTdecoder.h"
#include "plxVTdecoderDlg.h"
...
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
// CPlxVTdecoderDlg dialog
/////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////

CPlxVTdecoderDlg::CPlxVTdecoderDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CPlxVTdecoderDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CPlxVTdecoderDlg)
	//}}AFX_DATA_INIT
	// Note that LoadIcon does not require a subsequent DestroyIcon in Win32
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
	m_fileName		= "CM_Quickstart.plx";
	m_filePath      = "..\\SampleData\\";
	m_bOpen = false ;
}	

void CPlxVTdecoderDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPlxVTdecoderDlg)
...
BEGIN_MESSAGE_MAP(CPlxVTdecoderDlg, CDialog)
	//{{AFX_MSG_MAP(CPlxVTdecoderDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_CLOSE()
...
BOOL CPlxVTdecoderDlg::OnInitDialog()
{
	...
	m_buttonHeader.SetWindowText("Type                    Timestamp    X    Y  X/M    Y    X    Y") ;
...
void CPlxVTdecoderDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CPlxVTdecoderDlg::OnQueryDragIcon()
{
...
void CPlxVTdecoderDlg::OnBnClickedBrowse()
{
	CString filter;
...
int CPlxVTdecoderDlg :: ReadHeaders ()
{
	int iChannel ;
...
void CPlxVTdecoderDlg::Put(LPCTSTR lpszFormat, ...)
{
	CString str ;
...
void CPlxVTdecoderDlg::DumpHeaders()
{
	int iChannel ;
	int iUnit ;
	CString str ;
...
void CPlxVTdecoderDlg::OnBnClickedReadFile() {
...
void CPlxVTdecoderDlg :: EnableControlsToLoad ()
{
...
void CPlxVTdecoderDlg :: EnableControlsToExtract () 
{
	// The extract button is enabled since there is a file loaded to extract data from.
...
void CPlxVTdecoderDlg::OnExtract() 
{
	CWaitCursor wait;

    unsigned __int64 acceptable_delay = (unsigned __int64)( m_fileHeader.ADFrequency / 105.0 + 0.5 );
	...
	// Allocate a buffer for the waveform samples (used for skipping waveforms)
	...
	for (iBlock = 0 ; ;)
	{
        ...
        if( !accepted ) {
            ...
            if( VT_Acc_Mode( &acc ) != UNKNOWN ) {
                // Print valid VT data
    			m_listData.AddString( VT_Acc_Print( &acc ) );
            }
