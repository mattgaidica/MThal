saveDir = 'C:\Users\admin\Documents\MATLAB\MattGaidica\AcuteAnalysis\Headstage1\AllChHighPass_CommonModeReject';
...
for dataStart=1:dataStep:length(fdata_1)-dataLength
    ...
    for i=1:length(allCh)
        hs(i) = subplot(8,4,i);
        plot(wavefilter(fdata_1(allCh(i),dataStart:dataEnd)-fdata_1_cma(1,dataStart:dataEnd),5));
